...
print(f'Salário bruto: R${salarioBruto}\nValor pago ao INSS: R${salarioBruto * .08}\nValor pago ao sindicato: R${salarioBruto * .05}\nSalário líquido: R${salarioBruto - (salarioBruto * .08) - (salarioBruto * .05) - (salarioBruto * .11)}')